...
class Vehicle : public TrafficObject, public std::enable_shared_from_this<Vehicle>  // to enable the class to actually return a pointer to an instance of an object of itself (for sharepointers)
{
public:
    ...
    // miscellaneous
    std::shared_ptr<Vehicle> get_shared_this() { return shared_from_this(); }  // to enable the class to actually return a pointer to an instance of an object of itself (for sharepointers)
